---
title: "Verbos: Futuro Activo 1"
---

# Tiempo Futuro

¡Acá vienen más tablas! No hace falta que trates de memorizar estas conjugaciones (aunque ayudaría), simplemente metete en la lección y practicá un poco. ¡Pero por favor, leé las notas de acá abajo sobre el uso del futuro!

En el tiempo futuro solo hay una forma para yo, nosotros, ustedes plural y ellos/ellas (sin distinción de género), y la forma para "tú (masculino) + futuro" es la misma que para "ella + futuro". Solo la segunda y tercera persona singular tienen formas tanto para masculino como para femenino. Tomemos el verbo יכתוב (ichtov - escribirá) como ejemplo del futuro en pa'al:
...
*Esta forma se usa poco y también se puede usar con "הן".

Vas a notar pequeñas variaciones en esto, dependiendo del verbo, y como es habitual, hay una serie de verbos irregulares que vas a tener que aprender sobre la marcha.
...
Al igual que en el pasado, el verbo "ser/estar" también existe en el futuro:
...
<td>tú (sg. masc.) serás/estarás</td>
...
<td>nosotros seremos/estaremos</td>
...
<td>ustedes (pl. masc.) serán/estarán</td>
...
<td>ustedes (pl. fem.) serán/estarán</td>
...
<td>ellos/ellas (m + f) serán/estarán</td>
...
חשבתי שתהיה שם (literalmente "Pensé que estarás ahí".

El tiempo futuro en hebreo se traduce al español como "estarías": "Pensé que estarías ahí".
